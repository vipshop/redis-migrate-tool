...
struct RMTCommand rmtCommandTable[] = {
    ...
    {RMT_CMD_REDIS_CHECK, "Compare data between source group and target group. Default compare 1000 keys. You can set a key count behind. Note, redis_check command sometimes does not work for hash type.", 
